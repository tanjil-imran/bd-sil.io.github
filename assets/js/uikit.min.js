...
! function(t, e) {
    ...
    function Xt() {
        ...
        var n, i, r = Qt(t),
            ...
            u = r[4],
            o = ie(o);
        return 1 < h.length && (n = h, h = function(t) {
                return k(t.detail) ? n.apply(void 0, [t].concat(t.detail)) : n(t)
            }), u && u.self && (i = h, h = function(t) {
            ...
            }(o, a, h)), u = te(u), s.split(" ").forEach(function(e) {
    ...
    function ge(t, e, n, i) {
        ...
        var r = (e = V(e)).length;
        return t = P(t) ? F(t) : "next" === t ? n + 1 : "previous" === t ? n - 1 : me(e, t), i ? tt(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    ...
    function Le(t) {
        ...
        r.length && (i = D(J(r = je(r))) ? [] : r.pop(), r = r.filter(Boolean), V(t).forEach(function(t) {
        ...
        return void 0 === s && (s = 200), ae.all(V(t).map(function(o) {
            return new ae(function(n, i) {
                ...
                Jt(o, "animationend animationcanceled", function(t) {
                    ...
                    self: !0
                }), Re(o, "animationDuration", s + "ms"), De(o, e, tn + (h ? "leave" : "enter")), w(e, tn) && De(o, a && "uk-transform-origin-" + a, h && tn + "reverse")
            })
        }))
    }
    ...
    function sn(t, e, c, l, d, n, i, r) {
        ...
        var o, p = hn(t),
            m = hn(e),
            g = m;
        return mn(g, c, p, -1), mn(g, l, m, 1), d = vn(d, p.width, p.height), n = vn(n, m.width, m.height), d.x += n.x, d.y += n.y, g.left += d.x, g.top += d.y, i && (o = [hn(R(t))], r && o.unshift(hn(r)), K(on, function(t, s) {
            var a = t[0],
                h = t[1],
                u = t[2];
            !0 !== i && !b(i, a) || o.some(function(i) {
                ...
                function o(e, t) {
                    var n = (g[h] + e + t - 2 * d[a]).toFixed(4);
                    if (n >= i[h] && n + p[s] <= i[u]) return g[h] = n, ["element", "target"].forEach(function(t) {
    ...
    function an(n, i) {
        ...
        ["left", "top"].forEach(function(t) {
            var e;
            t in i && (e = Re(n, t), Re(n, t, i[t] - r[t] + j("absolute" === o && "auto" === e ? un(n)[t] : e)))
        })
    }
    ...
    function hn(t) {
        ...
        jt(t) || "none" !== Re(t, "display") || (e = ot(t, "style"), n = ot(t, "hidden"), ot(t, {
    ...
    function bn(t, e, n) {
        return void 0 === e && (e = "width"), void 0 === n && (n = window), P(t) ? +t : u(t, "vh") ? xn(ln(R(n)), t) : u(t, "vw") ? xn(dn(R(n)), t) : u(t, "%") ? xn(hn(n)[e], t) : j(t)
    }
    ...
    function ii(t, e) {
        ...
        for (var s in r) {
            var a = d(s),
                h = ht(o, a);
            H(h) || (h = r[s] === Boolean && "" === h || oi(r[s], h), ("target" !== a || h && !w(h, "_")) && (n[s] = h))
        }
        var u = Mn(ht(o, e), i);
        for (var c in u) {
            var l = f(c);
    ...
    Un.util = Object.freeze({
            ...
            scrollParents: Fn,
            getViewport: jn
        }), Un.data = "__uikit__", Un.prefix = "uk-", Un.options = {}, Un.version = "3.5.6", Gn = (Yn = Un).data, Yn.use = function(t) {
        ...
        }, Zn = 0, (Kn = Un).prototype._init = function(t) {
            (t = t || {}).data = function(t, e) {
                ...
                if (n = k(n) ? O(i) ? void 0 : n.slice(0, i.length).reduce(function(t, e, n) {
                    ...
                    for (var o in n) H(n[o]) ? delete n[o] : n[o] = r[o] ? oi(r[o], n[o]) : n[o];
                return n
            }(t, this.constructor.options), this.$options = Nn(this.constructor.options, t, this), this.$el = null, this.$props = {}, this._uid = Zn++, this._initData(), this._initMethods(), this._initComputeds(), this._callHook("created"), t.el && this.$mount(t.el)
            ...
            var e;
            for (e in t = t || ii(this.$options, this.$name)) H(t[e]) || (this.$props[e] = t[e]);
            ...
            t && t.forEach(function(t) {
                if (l(t, "handler")) ri(n, t);
                else
                    for (var e in t) ri(n, t[e], e)
            })
        ...
        }, ti = (Qn = Un).data, ei = {}, Qn.component = function(s, t) {
            var e = d(s);
            if (s = f(e), !t) return T(ei[s]) && (ei[s] = Qn.extend(ei[s])), ei[s];
            Qn[s] = function(t, n) {
            ...
            return n.name = s, n.install && n.install(Qn, n, s), Qn._initialized && !n.functional && yn.read(function() {
            ...
            if (t[ti])
                for (var e in t[ti]) t[ti][e]._callConnected();
            for (var n = 0; n < t.attributes.length; n++) {
                var i = qn(t.attributes[n].name);
                i && i in ei && Qn[i](t)
            }
        }, Qn.disconnect = function(t) {
            for (var e in t[ti]) t[ti][e]._callDisconnected()
        },
        function(i) {
            var r = i.data;
        ...
        ai = {
            ...
            methods: {
                ...
                _toggleElement: function(t, e, n) {
                    ...
                    var o, r = ($(n) ? n : !1 !== n && this.hasAnimation ? this.hasTransition ? hi(this) : (o = this, function(t, e) {
                        rn.cancel(t);
                        var n = o.animation,
                            i = o.duration,
                            r = o._toggle;
    ...
    function hi(t) {
        ...
        return function(t, e) {
            ...
            var o = ln(t) + (n ? 0 : i);
            return ln(t, r), (e ? Qe.start(t, G({}, h, {
                overflow: "hidden",
                height: o
    ...
    var ui = {
        ...
        events: [{
            ...
            handler: function(t) {
                t.preventDefault(), this.toggle(me(Me(this.targets + " " + this.$props.toggle, this.$el), t.current))
            }
        }],
        methods: {
            toggle: function(t, r) {
                ...
                this.multiple || b(n, e[0]) || (e = e.concat(n)), !this.collapsible && n.length < 2 && !Rt(e, ":not(." + this.clsOpen + ")").length || e.forEach(function(t) {
                    return o.toggleElement(t, !He(t, o.clsOpen), function(e, n) {
                        ...
                        if (!1 !== r && o.hasTransition) return e._wrapper || (e._wrapper = Ie(i, "<div" + (n ? " hidden" : "") + ">")), ci(i, !1), hi(o)(e._wrapper, n).then(function() {
                            var t;
                            ci(i, !n), delete e._wrapper, Te(i), n && (Pn(t = Ne(o.$props.toggle, e)) || Hn(t, {
                                offset: o.offset
                            }))
                        });
                        ci(i, !n)
    ...
    var li = {
        ...
        di = {
            ...
            connected: function() {
                this.inView && !st(this.$el, "preload") && (this.$el.preload = "none"), this.player = new zn(this.$el), this.automute && this.player.mute()
            },
            update: {
                read: function() {
                    return !!this.player && {
    ...
    var pi, mi = {
        ...
        gi = {
            ...
            events: [{
                ...
                handler: function() {
                    var o = this;
                    (pi = this).tracker.init(), Kt(this.$el, "updatearia"), Jt(this.$el, "hide", Xt(document, mt, function(t) {
                        var r = t.target;
                ...
                handler: function(t) {
                    var e = t.target;
                    this.$el === e ? (pi = this.isActive() ? null : pi, Kt(this.$el, "updatearia"), this.tracker.cancel()) : pi = null === pi && qt(e, this.$el) && this.isToggled() ? this : pi
                }
            }, {
                name: "updatearia",
                self: !0,
                ...
                show: function(t, e) {
                    ...
                    if (void 0 === t && (t = this.toggle), void 0 === e && (e = !0), this.isToggled() && t && this.toggle && t.$el !== this.toggle.$el && this.hide(!1), this.toggle = t, this.clearTimers(), !this.isActive()) {
                        if (pi) {
                            ...
                            for (; pi && n !== pi && !qt(this.$el, pi.$el);)(n = pi).hide(!1)
                        }
        ...
        for (var i = [
            ...
            if (jt(o))
                for (var s = ki(o), a = i.length - 1; 0 <= a; a--) {
                    ...
                    var u = void 0,
                        u = h[0].offsetParent === o.offsetParent ? ki(h[0]) : (s = ki(o, !0), ki(h[0], !0));
        ...
        update: [{
            ...
            read: function(t) {
                ...
                var r, o, s, a, h, u = i.some(Qe.inProgress),
                    ...
                    d = (r = i, o = this.margin, j((s = r.filter(function(t) {
                        return He(t, o)
        ...
        update: {
            read: function(t) {
                ...
                if (this.expand) {
                    ...
                    var r, n = "calc(100vh";
                    this.offsetTop && (n += 0 < (r = an(this.$el).top) && r < ln(window) / 2 ? " - " + r + "px" : ""), !0 === this.offsetBottom ? n += " - " + Ci(this.$el.nextElementSibling) + "px" : P(this.offsetBottom) ? n += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? n += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (n += " - " + Ci(yt(this.offsetBottom, this.$el)) + "px"), n += (i ? " - " + i + "px" : "") + ")"
                }
                return {
                    minHeight: n,
                    prev: e
            ...
            write: function(t) {
                ...
                Re(this.$el, {
                    minHeight: e
                }), e !== n && this.$update(this.$el, "resize"), this.minHeight && j(Re(this.$el, "minHeight")) < this.minHeight && Re(this.$el, "minHeight", this.minHeight)
            },
            events: ["resize"]
        }
    };
    ...
    var Ai = {
            ...
            disconnected: function() {
                var e = this;
                Ft(this.$el) && ot(this.$el, "hidden", null), this.svg && this.svg.then(function(t) {
            ...
            update: {
                ...
                write: function() {
                    var t, e;
                    t = this.svgEl, (e = Di(t)) && t.style.setProperty("--uk-animation-stroke", e)
                },
                type: ["resize"]
            },
            methods: {
                    ...
                    return function(n) {
                        ...
                        return function(t, e) {
                            e && b(t, "<symbol") && (t = function(t, e) {
                                if (!zi[t]) {
                                    var n;
                                    for (zi[t] = {}, Mi.lastIndex = 0; n = Mi.exec(t);) zi[t][n[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + n[1] + "svg>"
                                }
                                return zi[t][e]
                            }(t, e) || t);
    ...
    var Ri = {
        ...
        connected: function() {
            Qi[this.cacheKey] ? qi(this.$el, Qi[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && qi(this.$el, function(t, e, n) {
                ...
                n && (i = rt.ratio({
                    width: t,
                    height: e
                }, "width", bn(Yi(n))), t = i.width, e = i.height);
                return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="' + t + '" height="' + e + '"></svg>'
            }(this.width, this.height, this.sizes)), this.observer = new Rn(this.load, {
        ...
        update: {
            ...
            write: function(t) {
                var e, n, i, r, o;
                this.dataSrcset && 1 !== window.devicePixelRatio && (!(e = Re(this.$el, "backgroundSize")).match(/^(auto\s?)+$/) && j(e) !== t.bgSize || (t.bgSize = (n = this.dataSrcset, i = this.sizes, r = bn(Yi(i)), (o = (n.match(Ji) || []).map(j).sort(function(t, e) {
                    return t - e
                })).filter(function(t) {
                    return r <= t
        ...
        methods: {
            load: function(t) {
                ...
                t.some(function(t) {
                    ...
                    return qi(e.$el, Zi(t), t.srcset, t.sizes), Qi[e.cacheKey] = Zi(t), t
                }, function(t) {
    ...
    function qi(t, e, n, i) {
        Ki(t) ? (i && (t.sizes = i), n && (t.srcset = n), e && (t.src = e)) : e && !b(t.style.backgroundImage, e) && (Re(t, "backgroundImage", "url(" + Ht(e) + ")"), Kt(t, Zt("load", !1)))
    }
    ...
    var nr = {
        ...
        or = {
            ...
            events: [{
                ...
                self: !0,
                handler: function(t) {
                    t.defaultPrevented || (t.preventDefault(), this.isToggled() === b(rr, this) && this.toggle())
                }
            }, {
                name: "beforeshow",
                self: !0,
                handler: function(t) {
                    ...
                    !this.stack && rr.length ? (ae.all(rr.map(function(t) {
                        return t.hide()
                    })).then(this.show), t.preventDefault()) : rr.push(this)
                }
            }, {
                name: "show",
                self: !0,
                handler: function() {
                    var o = this;
                    dn(window) - dn(document) && this.overlay && Re(document.body, "overflowY", "scroll"), this.stack && Re(this.$el, "zIndex", Re(this.$el, "zIndex") + rr.length), De(document.documentElement, this.clsPage), this.bgClose && Jt(this.$el, "hide", Xt(document, mt, function(t) {
                        var r = t.target;
                        ...
                        27 === t.keyCode && J(rr) === o && (t.preventDefault(), o.hide())
                    }), {
                        self: !0
                    })
                }
                ...
                handler: function() {
                    var e = this;
                    rr.splice(rr.indexOf(this), 1), rr.length || Re(document.body, "overflowY", ""), Re(this.$el, "zIndex", ""), rr.some(function(t) {
        ...
        ur = {
            ...
            events: [{
                ...
                handler: function(t, e) {
                    var n = e.$el,
                        i = e.dir;
                    "slide" === this.dropbarMode && De(this.dropbar, "uk-navbar-dropbar-slide"), this.clsDrop && De(n, this.clsDrop + "-dropbar"), "bottom" === i && this.transitionTo(n.offsetHeight + j(Re(n, "marginTop")) + j(Re(n, "marginBottom")), n)
                }
            }, {
                name: "beforehide",
                filter: function() {
    ...
    var dr = {
        ...
        pr = {
            ...
            methods: {
                scrollTo: function(t) {
                    var e = this;
                    t = t && Ne(t) || document.body, Kt(this.$el, "beforescroll", [this, t]) && Hn(t, {
                        offset: this.offset
                    }).then(function() {
            ...
            update: [{
                read: function(t) {
                    ...
                    t.update && this.elements.forEach(function(t) {
                        ...
                        }).show = Pn(t, n.offsetTop, n.offsetLeft), t._ukScrollspyState = e
                    })
                },
                write: function(i) {
                    var r = this;
            ...
            update: [{
                read: function() {
                    ...
                    return i === s ? a = t - 1 : (this.targets.every(function(t, e) {
                        if (un(t, o).top - n.offset <= 0) return a = e, !0
        ...
        vr = {
            ...
            update: [{
                read: function(t, e) {
                    ...
                    return this.top = Math.max(j(wr("top", this)), this.topOffset) - this.offset, this.bottom = i && i - this.$el.offsetHeight, this.width = an(jt(this.widthElement) ? this.widthElement : this.$el).width, {
                        height: n,
                ...
                write: function(t, e) {
                    ...
                    if (!((t.lastScroll = h) < 0 || h === a && "scroll" === e || this.showOnUp && "scroll" !== e && !this.isFixed || ((300 < i - r || o !== s) && (t.initScroll = h, t.initTimestamp = i), t.lastDir = o, this.showOnUp && !this.isFixed && Math.abs(t.initScroll - h) <= 30 && Math.abs(a - h) <= 10)))
                        if (this.inactive || h < this.top || this.showOnUp && (h <= this.top || "down" === o && "scroll" === e || "up" === o && !this.isFixed && h <= this.bottomOffset)) {
                            ...
                            this.isFixed = !1, this.animation && h > this.topOffset ? (rn.cancel(this.$el), rn.out(this.$el, this.animation).then(function() {
                                return n.hide()
                            }, et)) : this.hide()
    ...
    }), xr = (br = Un).connect, yr = br.disconnect, ut && window.MutationObserver && yn.read(function() {
        document.body && Ae(document.body, xr);
        new MutationObserver(function(t) {
            var r = [];
            t.forEach(function(t) {
                return n = r, i = (e = t).target, void(("attributes" !== e.type ? function(t) {
                    for (var e = t.addedNodes, n = t.removedNodes, i = 0; i < e.length; i++) Ae(e[i], xr);
                    for (var r = 0; r < n.length; r++) Ae(n[r], yr);
                    return 1
                } : function(t) {
                    var e = t.target,
                        n = t.attributeName;
        ...
        _r = {
            ...
            methods: {
                animate: function(t, i) {
                    ...
                    t(), Qe.cancel(i), r.forEach(Qe.cancel), Ar(i), this.$update(i, "resize"), yn.flush();
                    var a = ln(i),
                    ...
                    return De(i, Er), r.forEach(function(t, e) {
                        return o[e] && Re(t, o[e])
                    }), Re(i, {
                        height: e,
                        display: "block"
                    }), On(window, s), ae.all(r.map(function(t, e) {
                        ...
                        }), Ar(i), n.$update(i, "resize"), yn.flush()
                    }, et)
                }
            }
        };
    ...
    function Dr(t, e, n) {
        ...
        var s, a, h, u = t.sort,
            c = u[0],
            l = u[1];
        c && (a = c, h = l, Y(s = G([], n).sort(function(t, e) {
            ...
            methods: {
                start: function() {
                    ...
                    this.unbindMove = function() {
                        e(), t.unbindMove = null
                    }, Xt(window, "scroll", this.unbindMove), Xt(window.visualViewport, "resize", this.unbindMove), Xt(document, vt + " " + xt, this.end, !0), Re(this.list, "userSelect", "none")
                },
                move: function(t) {
                    var e = this;
                    if (this.unbindMove) {
                        ...
                        if (!(0 == n || this.prevPos === this.pos || !this.dragging && Math.abs(n) < this.threshold)) {
                            ...
                            [this.index, this.prevIndex].filter(function(t) {
                                ...
                                Kt(i[t], "itemhidden", [e]), d && (h = !0, e.prevIndex = r)
                            }), (this.index === r && this.prevIndex !== r || h) && Kt(i[this.index], "itemshown", [this]), l && (this.prevIndex = r, this.index = s, d || Kt(u, "beforeitemhide", [this]), Kt(c, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), u, !d && c), l && (d || Kt(u, "itemhide", [this]), Kt(c, "itemshow", [this]))
                        }
                    }
                },
                end: function() {
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(t) {
                        ...
                        Le(t, n.clsActive, F(e) === i), Le(t, "uk-invisible", n.finite && ("previous" === e && 0 === i || "next" === e && i >= n.maxIndex))
                    })
                }
            }
        }],
                ...
                if (void 0 === e && (e = !1), !this.dragging && this.length) {
                    ...
                    if (i[e ? "unshift" : "push"](t), !e && 1 < i.length) 2 === i.length && this._transitioner.forward(Math.min(this.duration, 200));
                        ...
                        var s, a, h = this.getIndex(this.index),
                            ...
                            l = this.slides[c];
                        if (u !== l) {
                            if (this.dir = (a = h, "next" !== (s = t) && ("previous" === s || s < a) ? -1 : 1), this.prevIndex = h, this.index = c, u && !Kt(u, "beforeitemhide", [this]) || !Kt(l, "beforeitemshow", [this, u])) return this.index = this.prevIndex, void o();
                            var d = this._show(u, l, e).then(function() {
                                return u && Kt(u, "itemhidden", [n]), Kt(l, "itemshown", [n]), new ae(function(t) {
                                    yn.write(function() {
                                        i.shift(), i.length ? n.show(i.shift(), !0) : n._transitioner = null, t()
                                    })
                                })
                            });
                            return u && Kt(u, "itemhide", [this]), Kt(l, "itemshow", [this]), d
                        }
                        o()
                    }
                }
    ...
    var Rr = {
        ...
        qr = {
            ...
            events: [{
                ...
                name: "beforeitemshow",
                handler: function(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleElement(this.$el, !0, !1), this.animation = Fr.scale, Be(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler: function() {
                ...
                handler: function(t, r) {
                    ...
                    var a, h, n, u = r.poster,
                        c = r.attrs;
                    void 0 === c && (c = {}), this.setItem(r, "<span uk-spinner></span>"), i && (h = {
                        frameborder: "0",
                        allow: "autoplay",
                        allowfullscreen: "",
    ...
    var Yr, Xr = {
        ...
        methods: {
            show: function(t) {
                ...
                return N(t) && (n = Gr(t).source, t = y(i, function(t) {
                    var e = t.source;
                    return n === e
    ...
    var Jr = {
        ...
        connected: function() {
            var t, e = this,
                n = j(Re(this.$el, this.marginProp));
        ...
        Zr = {
                ...
                props: function(m, g) {
                    ...
                    return Kr.reduce(function(t, e) {
                        ...
                        if (r ? (a = g.style.color, s = s.map(function(t) {
                            ...
                            }), g.style.color = a) : w(e, "bg") ? (h = "bgy" === e ? "height" : "width", s = s.map(function(t) {
                                return bn(t, h, v.$el)
                            }), Re(g, "background-position-" + e[2], ""), i = Re(g, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1], n = v.covers ? (u = Math.min.apply(Math, s), c = Math.max.apply(Math, s), l = s.indexOf(u) < s.indexOf(c), d = c - u, s = s.map(function(t) {
                                return t - (l ? u : c)
                            }), (l ? -d : 0) + "px") : i) : s = s.map(j), "stroke" === e) {
                            if (!s.some(function(t) {
                                    return t
                                })) return t;
                            var p = Di(v.$el);
                            Re(g, "strokeDasharray", p), "%" === f && (s = s.map(function(t) {
                                return t * p / 100
            ...
            update: {
                read: function(t) {
                    ...
                    }, c = rt.cover(u, h), this.bgProps.forEach(function(t) {
                        var e, n = l.props[t],
                            i = n.diff,
                            r = n.bgPos,
                            o = n.steps,
        ...
        update: {
            read: function(t, e) {
                ...
                if ("scroll" !== e && (n = !1), t.active) {
                    var i, r, o = n;
                    return i = Ln(this.target) / (this.viewport || 1), r = this.easing, {
    ...
    function no(t, e, n) {
        var i, r = oo(t, e);
        return n ? r - (i = t, an(e).width / 2 - an(i).width / 2) : Math.min(r, io(e))
    }
                ...
                Transitioner: function(r, i, o, t) {
                    ...
                    return {
                        ...
                        show: function(t, e, n) {
                            void 0 === e && (e = 0);
                            var i = n ? "linear" : s;
                            return t -= Math.round(t * tt(e, -1, 1)), this.translate(e), r && this.updateTranslates(), e = r ? e : tt(e, 0, 1), so(this.getItemIn(), "itemin", {
                                percent: e,
                                duration: t,
                                timing: i,
                                dir: o
                        ...
                        translate: function(t) {
                            ...
                            Re(a, "transform", Hr(tt(e - e * t - u, -ro(a), an(a).width) * (lt ? -1 : 1), "px")), this.updateTranslates(), r && (t = tt(t, -1, 1), so(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: o
            ...
            computed: {
                ...
                maxIndex: function() {
                    ...
                    for (var t = io(this.list), e = this.length; e--;)
                        if (oo(this.list.children[e], this.list) < t) return Math.min(e + 1, this.length - 1);
                    return 0
                },
                sets: function(t) {
                    var o = this,
                    ...
                    return !O(e = e && this.slides.reduce(function(t, e, n) {
                        var i, r = an(e).width;
                        return a < u + r && (!o.center && n > o.maxIndex && (n = o.maxIndex), b(t, n) || (i = o.slides[n + 1], o.center && i && r < h - an(i).width / 2 ? h -= r : (h = s, t.push(n), a = u + s + (o.center ? r / 2 : 0)))), u += r, t
                    }, [])) && e
                },
                transitionOptions: function() {
                    return {
            ...
            events: {
                beforeitemshow: function(t) {
                    ...
                    if (!this.dragging && 1 < e) {
                        ...
                        t.preventDefault()
                    } else this.duration = Vr(this.avgWidth / this.velocity) * (an(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth), this.reorder()
                },
                itemshow: function() {
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = t.type,
                        ...
                        o = n.timing,
                        s = n.dir;
                    Qe.cancel(this.$el), Re(this.$el, this.getCss(lo(e, s, i))), Qe.start(this.$el, this.getCss(co(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(et)
                }
            }, {
                ...
                handler: function(t) {
                    var e = t.type,
                        ...
                        i = n.percent,
                        r = n.dir;
                    Qe.cancel(this.$el), Re(this.$el, this.getCss(lo(e, r, i)))
                }
            }]
        };
            ...
            methods: {
                init: function(t) {
                    ...
                    !r || i || 0 < n || Vt(e) || qt(e, "." + this.clsNoDrag) || this.handle && !qt(e, this.handle) || (t.preventDefault(), this.touched = [this], this.placeholder = r, this.origin = G({
                        target: e,
                        index: me(r)
                    }, this.pos), Xt(document, gt, this.move), Xt(document, vt, this.end), this.threshold || this.start(t))
                },
                start: function(t) {
                    var e, n, i;
                    ...
                    }), De(this.drag, this.clsDrag, this.clsCustom), De(this.placeholder, this.clsPlaceholder), De(this.items, this.clsItem), De(document.documentElement, this.clsDragState), Kt(this.$el, "start", [this, this.placeholder]), r = this.pos, o = Date.now(), fo = setInterval(function() {
                        var t = r.x,
                            a = r.y;
                        a += window.pageYOffset;
                        var h = .3 * (Date.now() - o);
                        o = Date.now(), Fn(document.elementFromPoint(t, r.y)).some(function(t) {
                            var e = t.scrollTop,
                                n = t.scrollHeight,
                                i = an(jn(t)),
                                r = i.top,
                ...
                insert: function(n, i) {
                    ...
                    function t() {
                        var t, e;
                        i ? (!qt(n, r.target) || (e = i, (t = n).parentNode === e.parentNode && me(t) > me(e)) ? xe : ye)(i, n) : be(r.target, n)
                    }
            ...
            methods: {
                show: function() {
                    ...
                    !this.isActive() && this.title && (wo.forEach(function(t) {
                        return t.hide()
                    }), wo.push(this), this._unbind = Xt(document, vt, function(t) {
                ...
                hide: function() {
                    ...
                    this.isActive() && !zt(this.$el, "input:focus") && this.toggleElement(this.tooltip, !1, !1).then(function() {
                        wo.splice(wo.indexOf(t), 1), clearTimeout(t.showTimer), t.tooltip = $e(t.tooltip), t._unbind()
                    })
                },
                _show: function() {
                    var e = this;
        ...
        xo = {
            ...
            events: {
                ...
                dragleave: function(t) {
                    ko(t), Be(this.$el, this.clsDragover)
                }
            },
            methods: {
                upload: function(t) {
                    ...
                    if (t.length) {
                        ...
                        for (var e = 0; e < t.length; e++) {
                            ...
                            if (this.allow && !yo(this.allow, t[e].name)) return void this.fail(this.msgInvalidName.replace("%s", this.allow));
                            if (this.mime && !yo(this.mime, t[e].type)) return void this.fail(this.msgInvalidMime.replace("%s", this.mime))
                        }
